...
class MappingSearch(admin.ModelAdmin):
    ...
    list_display = (
    'emp_name', 'emp_id', 'emp_desi', 'emp_rm1', 'emp_rm2', 'emp_rm3', 'new_rm1', 'new_rm2', 'new_rm3', 'emp_process',
    'new_process', 'status')
...
class LeaveTableSearch(admin.ModelAdmin):
    search_fields = ('emp_name', 'emp_id')
    list_display = (
    'emp_name', 'emp_id', 'applied_date', 'leave_type', 'start_date', 'end_date', 'no_days', 'tl_approval',
    'manager_approval', 'escalation', 'status')
...
class OnboardingnewHRCResourse(resources.ModelResource):
    class Meta:
        ...
        fields = ['emp_id', 'emp_name', 'emp_dob', 'emp_desig', 'emp_process', 'emp_pan', 'emp_aadhar',
                  'emp_father_name',
